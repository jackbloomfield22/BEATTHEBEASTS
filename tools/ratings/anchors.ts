...
export const ANCHORS: Anchor[] = [
  ...
  { ids: ['players:dan-marino:MIA:1980s'], label: 'Dan Marino (1980s MIA)', checks: [ge('release', 99), ge('throwPower', 95), bottom10('scramble')], review: 'Release now fails (ratings follow-up, sack-rate split): 97.9, rank 4 of 634 behind Steve Young, Montana and Peyton Manning (IND), where 99 needs rank 1–3. His 99 came from sack rate (the lowest of his era), which the approved split moved out of Release into Pocket Presence, where he is 99. Release now reads completion % and passing volume vs league, INT rate and honors; his completion % (+3 points vs league) is good, not the best. I\'d accept 97+ Release, or move the 99 to Pocket Presence; your call. Throw Power passes (air yards and the sourced arm grade, approved earlier: "cannon" from pro-era descriptions); bottom-10% Scramble passes.' },
  ...
  { ids: ['players:lamar-jackson:BAL:2010s', 'players:lamar-jackson:BAL:2020s'], label: 'Lamar Jackson (BAL)', checks: [ge('speed', 95)], approved: `${FU} Speed 97+ → 95+ (96.5 from his commonly cited 4.34; he never ran at the combine, and 97+ needs about 4.30 electronic on this scale).` },
