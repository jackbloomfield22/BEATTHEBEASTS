...
export const ANCHORS: Anchor[] = [
  ...
  { ids: ['players:larry-fitzgerald:ARI:2000s'], label: 'Larry Fitzgerald (2000s ARI)', checks: [ge('catchInTraffic', 97)], review: 'Catch in Traffic is 94.6: height, TDs per catch, volume and honors put Calvin Johnson, Rice and Owens above him. I\'d accept 93+. (The \'speed below 88\' band was dropped after the M2 review: his measured 4.48 combine 40 stands.)' },
