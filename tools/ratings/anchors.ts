...
export const ANCHORS: Anchor[] = [
  ...
  { ids: ['players:larry-fitzgerald:ARI:2000s'], label: 'Larry Fitzgerald (2000s ARI)', checks: [ge('catchInTraffic', 97), lt('speed', 88)], review: 'Catch in Traffic lands at 94–95 (height, TDs per catch, volume, honors); the pool\'s top includes Calvin Johnson, Rice and T.O. Speed comes from his measured time; see the value.' },
