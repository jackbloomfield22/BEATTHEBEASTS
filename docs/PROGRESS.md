...
- *Diagnosis, nothing changed*: estimated pre-1999 inputs are never discounted (confidence is a label; shrinkage is by games only), the estimated 1976–77 yardage baselines are 2–4% low (about 1% over a 1970s stint), fumbles per touch is not era-adjusted (median RB Ball Security 52 for 1970s stints vs 77 for 2020s: a modern edge), and at DE the top-3 edge over White and Smith is verified measurables against body priors plus Smith's long-stint sack rate. White's 1990–92 Eagles seasons are in no stint.
