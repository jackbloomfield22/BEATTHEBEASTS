...
OVR weights, the curve and calibration are unchanged. The only attribute formula that changed is QB Throw Power (user-approved, below); anchors, traits, the Explorer and a consensus check moved too.
